...
public class MazeController implements Order {
	...
	static String userDriver = "Wizard";
	static Builder userBuilder = Builder.DFS;
	...
	public void deliver(MazeConfiguration mazeConfig) {
		...
		switch(MazeController.userDriver) {
			case "WallFollower":
		...
		System.out.println("Diff: " + userDifficulty + " |  Build: " + userBuilder + " |  Driver: " + userDriver);
