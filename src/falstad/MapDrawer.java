	...
	public void draw_map(MazePanel gc, int px, int py, int walk_step, int view_dx, int view_dy, boolean showMaze, boolean showSolution) {
		...
		for (int y = ymin; y <= ymax; y++)
			for (int x = xmin; x <= xmax; x++) {
				...
				gc.setColor(seencells.hasWall(x,y, CardinalDirection.North) ? MazePanel.White : MazePanel.Gray);
				...
				gc.setColor(seencells.hasWall(x,y, CardinalDirection.West) ? MazePanel.White : MazePanel.Gray);
